...
1. **Bitcoin ETF 连续 5 日净流入**：过去一周累计流入约 $727M，是自 4 月以来首次连续 5 日正流入。此前 6 月创纪录的 $82 亿流出终于暂停。与此同时，Ethereum ETF 同期流入约 $196M，主要受 CLARITY 法案进展推动。

2. **Solana ETF 累计突破 $10 亿**：11 只现货 Solana ETF 总资产管理规模突破 $10 亿大关。Bitwise 的 BSOL 独占近 $270M 流入。这是继 BTC、ETH 之后第三个达到此里程碑的加密资产。

3. **CLARITY 法案进入参议院全体投票阶段**：众议院已以 294-134 通过，参议院银行委员会 5 月以 15-9 放行。目前等待参议院全体表决。Trump 据报同意了争议已久的伦理条款（限制官员从加密行业获利），法案通过概率回升。BTC 和 ETH 被归类为 CFTC 管辖的商品，证券类代币归 SEC。

4. **El Salvador 实测：BTC 量子计算恢复工具**：CoinDesk 报道，针对 Bitcoin 的量子计算威胁（量子计算机可能破解 ECDSA 签名），已有早期恢复工具进入测试阶段。这不是紧急事件，但意味着行业开始认真对待量子威胁的时间线。

5. **Move Industries 急撒清关系**：CEO Torab Torabi 在 X 上发声明，称 Move Industries 与申请破产的 MVMT Labs 是"完全独立的法律实体"，"正常运营中"。同时宣布战略转向跨境支付和稳定币结算。MOVE 代币当日再跌 2.3%。一家破产公司发行的代币还在交易——Web3 独有的魔幻现实主义。
